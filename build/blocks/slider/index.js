...
/***/ "./src/blocks/slider/constants.js":
/*!****************************************!*\
  !*** ./src/blocks/slider/constants.js ***!
  \****************************************/
 ...
 * as a slide.
 */
const ALLOWED_BLOCKS = ['crowdify/slide'];

/**
 * This is the default block we'll use for our slide.
 */
const DEFAULT_BLOCK = 'crowdify/slide';
 ...
 */
const DEFAULT_INNERBLOCK = 'core/cover';
...
const DEFAULT_TEMPLATE = [[DEFAULT_BLOCK, {}, [[DEFAULT_INNERBLOCK, {
...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/slider/editor.scss");
/* harmony import */ var _slider__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./slider */ "./src/blocks/slider/slider.js");
...
function Edit(props) {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_inspector__WEBPACK_IMPORTED_MODULE_4__.Inspector, {
    ...props
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...blockProps
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_slider__WEBPACK_IMPORTED_MODULE_3__.Slider, {
    clientId: clientId,
...
/* harmony import */ var _swiper_init__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./swiper-init */ "./src/blocks/slider/swiper-init.js");
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./constants */ "./src/blocks/slider/constants.js");
...
const Slider = ({
  ...
  const selectedBlock = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.select)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.store).getSelectedBlock();
  const sliderRef = (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_3__.useRefEffect)(element => {
    ...
    let slideOrder = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.select)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.store).getBlockOrder(clientId);
    ...
    const unsubscribeSliderUpdateListener = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.subscribe)(() => {
      const currentSlidesOrder = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.select)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.store).getBlockOrder(clientId);
  ...
  const innerBlocksProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useInnerBlocksProps)({
    ...
    template: _constants__WEBPACK_IMPORTED_MODULE_6__.DEFAULT_TEMPLATE,
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    ...innerBlocksProps
  }), navigation && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(Navigation, null)), selectedBlock?.clientId === clientId && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.ButtonBlockAppender, {
...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"crowdify/slider","version":"0.1.0","title":"Slider","category":"crowdify","keywords":["slider","slideshow","carousel"],"icon":"smiley","description":"Display a slider.","attributes":{"autoplay":{"type":"boolean","default":true},"navigation":{"type":"boolean","default":true},"pagination":{"type":"boolean","default":false},"autoheight":{"type":"boolean","default":true},"effect":{"type":"string","default":"slide"},"speed":{"type":"number","default":500},"direction":{"type":"string","default":"horizontal"},"clickablePagination":{"type":"boolean","default":true},"paginationType":{"type":"string","default":"bullets"},"slidesPerView":{"type":"number","default":1},"spaceBetween":{"type":"number","default":10},"delay":{"type":"number","default":3000},"loop":{"type":"boolean","default":true},"freeMode":{"type":"boolean","default":false},"sticky":{"type":"boolean","default":false}},"example":{},"supports":{"html":false,"align":["wide","full"],"className":true,"color":{"background":true,"gradients":true,"link":true,"text":true},"spacing":{"padding":true,"margin":["top","bottom"]}},"textdomain":"crowdify-blocks","editorScript":"file:./index.js","editorStyle":"file:./index.css","render":"file:./render.php","style":"file:./style-index.css","viewScript":"file:./view.js"}');
