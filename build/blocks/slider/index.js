...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/slider/editor.scss");
/* harmony import */ var _swiper_init__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./swiper-init */ "./src/blocks/slider/swiper-init.js");
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./constants */ "./src/blocks/slider/constants.js");
...
function Edit(props) {
  ...
  const sliderRef = (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_7__.useRefEffect)(element => {
    const options = {
      ...attributes,
      ...{
        autoplay: false,
    ...
    // Initialize slider.
    let slider = (0,_swiper_init__WEBPACK_IMPORTED_MODULE_10__.SwiperInit)(element, options);

    // Store the current slide order to detect changes, such as adding, removing, or reordering slides.
    let slideOrder = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_8__.select)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_6__.store).getBlockOrder(clientId);

    // Subscribe slider update events like adding, removing, or reordering slides.
    const unsubscribeSliderUpdateListener = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_8__.subscribe)(() => {
      const currentSlidesOrder = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_8__.select)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_6__.store).getBlockOrder(clientId);

      // Check if the slider has been changed.
      if (currentSlidesOrder.toString() !== slideOrder.toString()) {
        const selectedBlock = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_8__.select)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_6__.store).getSelectedBlock();
        ...
        window.requestAnimationFrame(() => {
          // Initialize slider.
          slider = (0,_swiper_init__WEBPACK_IMPORTED_MODULE_10__.SwiperInit)(element, options);
  ...
  const innerBlocksProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_6__.useInnerBlocksProps)({
    ...
    allowedBlocks: _constants__WEBPACK_IMPORTED_MODULE_11__.ALLOWED_BLOCKS,
    defaultBlock: {
      name: _constants__WEBPACK_IMPORTED_MODULE_11__.DEFAULT_BLOCK
    },
    directInsert: true,
    orientation: 'horizontal',
    template: _constants__WEBPACK_IMPORTED_MODULE_11__.SLIDE_TEMPLATE,
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    ...innerBlocksProps
  })), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_6__.ButtonBlockAppender, {
