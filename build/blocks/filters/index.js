...
/* harmony import */ var _wordpress_icons__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @wordpress/icons */ "./node_modules/@wordpress/icons/build-module/library/post-categories.js");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @wordpress/i18n */ "@wordpress/i18n");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/filters/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./edit */ "./src/blocks/filters/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./save */ "./src/blocks/filters/save.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./block.json */ "./src/blocks/filters/block.json");
/* harmony import */ var _utils_text_domain__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../utils/text-domain */ "./src/utils/text-domain.js");
/* harmony import */ var _slider_swiper_init__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../slider/swiper-init */ "./src/blocks/slider/swiper-init.js");
/* harmony import */ var _components_post_template_custom_toolbar__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../components/post-template-custom-toolbar */ "./src/components/post-template-custom-toolbar.js");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockVariation)('core/query', {
  name: CROWDIFY_POSTS,
  title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Posts', _utils_text_domain__WEBPACK_IMPORTED_MODULE_9__.TEXT_DOMAIN),
  attributes: {
...
const withSwiperSlider = BlockListBlock => props => {
  ...
  const sliderRef = (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_4__.useRefEffect)(element => {
    ...
    // Initialize slider.
    let slider = (0,_slider_swiper_init__WEBPACK_IMPORTED_MODULE_10__.SwiperInit)(element, options);
    slider.destroy();
    window.requestAnimationFrame(() => {
      // Initialize slider.
      slider = (0,_slider_swiper_init__WEBPACK_IMPORTED_MODULE_10__.SwiperInit)(element, options);
    });
    return () => {
      slider?.destroy();
    };
...
(0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_3__.addFilter)('editor.BlockListBlock', 'crowdify/add-slider', withSwiperSlider);
 ...
 */
const withPostTemplateControls = (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_4__.createHigherOrderComponent)(BlockEdit => props => {
  const {
    name,
    isSelected,
    attributes,
  ...
  const layoutType = crowdifyLayout?.type && crowdifyLayout?.type !== 'default' ? crowdifyLayout?.type : layout?.type ? layout?.type : 'default';
  const displayLayout = {
    ...layout,
    type: layoutType
  };
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, isSelected && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_post_template_custom_toolbar__WEBPACK_IMPORTED_MODULE_11__.PostTemplateCustomToolbar, {
...
(0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_3__.addFilter)('editor.BlockEdit', 'core/post-template', withPostTemplateControls);
...
(0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_3__.addFilter)('blocks.registerBlockType', 'crowdify/layout-attributes', addLayoutAttributes);

/***/ }),

/***/ "./src/blocks/filters/save.js":
/*!************************************!*\
  !*** ./src/blocks/filters/save.js ***!
  \************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/filters/editor.scss");
